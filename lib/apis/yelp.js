...
export async function getNeighborhoodContext(lat, lng, city, state) {
  ...
  const categories = [
    ...
    { key: 'shopping', alias: 'shopping', label: 'Shopping' },
    { key: 'gyms', alias: 'gyms', label: 'Gyms & Fitness' },
    { key: 'education', alias: 'education', label: 'Schools' },
    { key: 'medical', alias: 'physicians,hospitals,urgent_care', label: 'Medical Services' }  // key for stats, alias for API
  ]
